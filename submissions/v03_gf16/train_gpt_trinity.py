...
import sys
sys.path.insert(0, '.')
from trinity_physics import phi_lr_schedule, trinity_weight_init, fibonacci_attention_heads, phi_optimizer_factors, gf16_quantize_weights, gf16_dequantize_weights, compute_phi_scale
...
class Hyperparameters:
    use_phi_physics: bool = bool(int(os.environ.get("USE_PHI_PHYSICS", "0"))),  # Enable Trinity φ-physics hyperparameters
    # Data / tokenizer.
